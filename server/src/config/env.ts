...
const EnvSchema = z.object({
  ...
  FAKERADIO_TTS_PROVIDER: z.enum(["grok", "mimo", "fish"]).default("grok"),
  ...
  FAKERADIO_FISH_API_KEY: z.string().optional(),
  FAKERADIO_FISH_BASE_URL: z.string().url().default("https://api.fish.audio"),
  FAKERADIO_FISH_TTS_MODEL: z.string().min(1).default("s2-pro"),
